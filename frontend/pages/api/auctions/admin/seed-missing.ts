...
const AUCTION_NFTS = [
  ...
  },
  {
    ...
    totalScore: 320,
    fameVisibility: 70,
    scientificImportance: 70,
    rarity: 60,
    discoveryRecency: 60,
    culturalSignificance: 60,
    badgeTier: 'PREMIUM',
  },
  {
    name: 'Uranus',
